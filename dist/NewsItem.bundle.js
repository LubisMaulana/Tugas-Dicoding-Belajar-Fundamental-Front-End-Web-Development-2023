...
var NewsItem = /*#__PURE__*/function (_HTMLElement) {
  _inherits(NewsItem, _HTMLElement);
  ...
  _createClass(NewsItem, [{
    ...
    value: function render() {
      var _this2 = this;
      this.shadowDOM.innerHTML = "\n            <style>\n                ".concat((bootstrap_dist_css_bootstrap_min_css__WEBPACK_IMPORTED_MODULE_0___default()), "\n                *{\n                    font-family: 'Ubuntu', sans-serif;\n                }\n                p {\n                    display: -webkit-box;\n                    -webkit-box-orient: vertical;\n                    overflow: hidden;\n                }\n            </style>\n            <div class=\"col\">\n                <div class=\"card shadow-sm\">\n                    <img src=\"https://restaurant-api.dicoding.dev/images/medium/").concat(this._restaurant.pictureId, "\" style=\"width: 100%; height: 150px;\"></img>\n                    <div class=\"card-body\">\n                        <p class=\"card-text fw-bold fs-3\" style=\"-webkit-line-clamp:1\">").concat(this._restaurant.name, "</p>\n                        <p class=\"card-text fw-bold fs-6\" style=\"-webkit-line-clamp:1\">").concat(this._restaurant.city, "</p>\n                        <p class=\"card-text fs-6\" style=\"-webkit-line-clamp:5\">").concat(this._restaurant.description, "</p>\n                        <div class=\"d-flex justify-content-between align-items-center\">\n                            <div class=\"btn-group\">\n                                <button type=\"button\" class=\"btn btn-sm btn-outline-secondary\">View</button>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        ");
      this.shadowDOM.querySelector('button').addEventListener('click', function () {
        _this2._eventShowDetail(_this2._restaurant.id);
      });
    }
  }]);
  return NewsItem;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksubmission_kelasfe_intermediate"] = self["webpackChunksubmission_kelasfe_intermediate"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [771], () => (__webpack_require__(628)))
